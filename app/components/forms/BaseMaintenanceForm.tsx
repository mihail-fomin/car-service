    ...
    return (
        <>
            ...
            >
                ...
                {/* Автомобиль */}
                <label className="block text-sm font-medium text-gray-300">Автомобиль</label>
                <SelectMenu
                ...
                />
                {errors.carId && <p className="text-sm text-red-400">{errors.carId.message}</p>}
                ...
                <div>
                    ...
                    />
                    {errors.mileage && <p className="text-sm text-red-400">{errors.mileage.message}</p>}
                </div>
                ...
                <div className="flex gap-4">
                    ...
                    {onClose && (
                        <BaseButton className="flex-1 bg-gray-700 hover:bg-gray-600" type="button" onClick={onClose}>
                            Отмена
                        </BaseButton>
                    )}
                </div>
