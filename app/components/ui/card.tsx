...
export const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, ...props }, ref) => {
    return (
        <div className={`${className} rounded-lg border border-gray-700 bg-gray-800 shadow-sm`} ref={ref} {...props} />
    );
});

export const CardHeader = React.forwardRef<HTMLDivElement, CardHeaderProps>(({ className, ...props }, ref) => {
    return <div className={`${className} flex flex-col space-y-1.5 p-6`} ref={ref} {...props} />;
});
...
export const CardContent = React.forwardRef<HTMLDivElement, CardContentProps>(({ className, ...props }, ref) => {
    return <div className={`${className} p-6 pt-0`} ref={ref} {...props} />;
});
